...
class User(models.Model):
    ...
    full_name = models.CharField(verbose_name='Ism Familiya',max_length=100)
    ...
    email = models.CharField(verbose_name='Email', max_length=60,null=True)
...
class Product(models.Model):
    ...
    description = models.TextField(verbose_name="Mahsulot hagida", max_length=3000, null=True)
